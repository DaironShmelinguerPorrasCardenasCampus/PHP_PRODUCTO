...
$data = new Proveedor();
 ...
 $allProveedor = $data->obtenerProveedor();
        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td> <a  class="btn btn-danger" href="borrarProveedor.php?proveedor_id=<?= $val['proveedor_id']?>&&req=delete">BORRAR </a></td>
              <td> <a  class="btn btn-primary" href="editarProveedor.php?proveedor_id=<?=$val['proveedor_id']?>">MODIFICAR </a></td>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarProveedor.php" method="post">
              ...
              <div class=" col-12 m-2">
                <input type="submit" class="btn btn-primary" value="ADD PROVEEDOR" name="guardarProveedor"/>
              </div>
            </form>  
         </div>       
        </div>
