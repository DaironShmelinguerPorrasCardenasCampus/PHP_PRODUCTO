<?php
   ...
   $data = new Proveedor();
    ...
    if(isset($_POST['editar'])){
        ...
        $data-> setProveedorNombre($_POST['nombre']);
        $data-> setProveedorCel($_POST['celular']);
        $data-> setProveedorCity($_POST['ciudad']);
        
        
        $data->update();
        echo "<script> alert ('DATOS ACTUALIZADOS EXITOSAMENTE');document.location='proveedor.php'</script>";
    }   
